...
def main(model):
    ...
    if model == 'dense':
        ...
        rnn_model = models.RecurrentNetwork(100, 64, 2, 4,embeddings).double()
        ...
        cnn_model = models.ExperimentalNetwork(embeddings, 100, [2, 3, 4], 4, 0.5)
        optimizer = optim.Adam(cnn_model.parameters(), lr=0.001)
        train_model(cnn_model, loss_fn, optimizer, train_generator, dev_generator)
